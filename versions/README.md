# Implemention and Experimental Versions
In this directory, multiple variations of the algorithmic framework can be found with different parameters, node-type and variable operators. 
